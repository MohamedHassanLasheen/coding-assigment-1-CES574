...
# Drop the rows which contains missing data
...
y_predicted = np.dot(X_test_new, w)
...
# Print the shapes of the test arrays
print("x_test shape:", x_test.shape)
print("y_predicted shape:", y_predicted.shape)
print("y_test shape:", y_test.shape)

# Plot the predicted values against the actual test values and draw 45 degree line
plt.figure(figsize=(8, 8))
plt.scatter(y_test, y_predicted, label="Data", alpha=1, color='blue')
